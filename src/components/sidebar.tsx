    ...
    <aside className="flex flex-col w-56 min-h-screen bg-sidebar border-r border-border-soft">
      ...
      <div className="px-4 py-5 border-b border-border-soft">
        <div className="flex items-center gap-2">
          ...
          <span className="text-fg font-semibold tracking-tight text-sm">
            Scoutly
          </span>
        </div>
      </div>
      ...
      <div className="border-t border-border-soft">
        {/* Agent chat panel (expands upward) */}
        {agentOpen && (
        ...
        >
          <Sparkles className="w-4 h-4 shrink-0 text-accent group-hover:text-accent" />
